...
public class UIManager : MonoBehaviour
{
    ...
    public GameObject[] resultTitles; // [0]: Lose, [1]: Win
    ...
    private void UpdateExpBar()
    {
        ...
        expSlider.value = maxExp > 0 ? currentExp / maxExp : 0;
    }
    ...
    public void ShowWin()
    {
        if (resultTitles != null && resultTitles.Length > 1 && resultTitles[1] != null)
    ...
    {
        if (resultTitles != null && resultTitles.Length > 0 && resultTitles[0] != null)
